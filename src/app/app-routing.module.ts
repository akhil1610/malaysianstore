...
const routes: Routes = [
  ...
  {
    path: 'malaysiastores',
    loadChildren: () => import('./pages/malaysiastores/malaysiastores.module').then( m => m.MalaysiastoresPageModule)
  },
  {
    path: 'restaurents/:id',
    loadChildren: () => import('./pages/restaurents/restaurents.module').then( m => m.RestaurentsPageModule)
  },
  {
    path: 'image-modal',
